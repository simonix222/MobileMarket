package com.myaccademy.myappjh.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MobileMarket");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MobileMarket");
        ...
        config.getMapConfigs().put("com.myaccademy.myappjh.domain.*", initializeDomainMapConfig(jHipsterProperties));
